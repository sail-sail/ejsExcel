...
const replaceLast = function (tt, what, replacement) {
  var mthArr, num;
...
const Promise_fromCallback = function (cb, t) {
  return function () {
    var args;
...
const Promise_fromStandard = function (cb, t) {
  return function () {
    var args;
    args = Array.from(arguments);
    if (!t) {
...
const renderExcelCb = function (exlBuf, _data_, opt, callback) {
...
const getExcelEns = function (sharedStr, sheets) {
...
const charPlus = function (str, num) {
