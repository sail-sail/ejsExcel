...
var deflateRaw = zlib.deflateRaw;
...
Hzip.prototype.updateEntry = function(fileName,fileBuf,isDefRaw,callback){
	...
	if(typeof fileBuf === "function") fileBuf = undefined;
	if(typeof isDefRaw === "function") isDefRaw = undefined;
...
Hzip.prototype.toEntryBuf = function(fileName,fileBuf,isDefRaw,callback){
	...
	if(!Buffer.isBuffer(fileName)) fileName = Buffer.from(fileName);
